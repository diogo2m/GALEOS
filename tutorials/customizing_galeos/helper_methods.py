from galeos import Satellite, ProcessUnit, User, ComponentManager
...
@classmethod
def process_unit_collect_class_metris(cls) -> list:
    class_metrics = {
        "CPU Demand" : 0,
        "Memory Demand" : 0,
        "Storage Demand" : 0,
...
def load_extensions():
    User.collect_class_metrics = user_collect_class_metrics
    ProcessUnit.collect_class_metrics = process_unit_collect_class_metris
    Satellite.collect_class_metrics = satellite_collect_class_metrics
